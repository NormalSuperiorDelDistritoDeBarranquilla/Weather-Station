...
const locationFacts = [
  {
    ...
    description: 'La Playa ofrece un entorno con influencia marina, luminosidad intensa y dinámica atmosférica propia del Caribe colombiano.',
    icon: Waves,
  },
  {
    title: 'Referencia urbana',
    description: 'El sistema se presenta como una estación real en un barrio identificable, no como un dashboard abstracto.',
    icon: MapPin,
  },
  {
    title: 'Lectura con contexto',
    description: 'Ubicar el punto de captura ayuda a interpretar mejor temperatura, presión, luminosidad, lluvia y viento.',
    icon: Radar,
  },
]
...
export function LocationPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      <PublicHeader subtitle="Contexto territorial del punto de captura y lectura atmosférica" />
      ...
      <main className="page-enter mx-auto flex max-w-7xl flex-col gap-10 px-4 pb-8 pt-8 sm:px-6 lg:px-8">
        <section className="grid gap-8 xl:grid-cols-[1.02fr_0.98fr]">
          <article
            ...
            style={{
              backgroundImage:
                `linear-gradient(180deg, rgba(2,6,23,0.08) 0%, rgba(2,6,23,0.66) 55%, rgba(2,6,23,0.95) 100%), url(${sitePhotos.locationHero})`,
            }}
          >
            <div className="max-w-3xl">
              ...
              <h1 className="mt-6 font-display text-5xl leading-tight text-white sm:text-6xl">
                Barrio La Playa como referencia pública de la estación M1K1U.
              </h1>
              <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-200/90">
                ...
                geográfico y ambiental. El usuario entiende rápidamente que la telemetría pertenece a un punto real.
              </p>

              <div className="mt-8 flex flex-wrap gap-3">
                <StatusBadge label={location.city} tone="info" />
                <StatusBadge label={location.region} tone="neutral" />
                <StatusBadge label={latest?.active ? 'Estación activa' : 'Sin conexión'} tone={latest?.active ? 'success' : 'danger'} />
              </div>
            </div>
          </article>
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2">
              <div className="rounded-[1.7rem] border border-white/10 bg-white/5 p-5">
                ...
                <p className="mt-3 text-sm leading-6 text-slate-300">
                  Valor referencial para presentar el punto de despliegue de manera clara en la capa pública.
                </p>
              </div>
              ...
              <div className="rounded-[1.7rem] border border-white/10 bg-white/5 p-5">
                ...
                <p className="mt-3 text-sm leading-6 text-slate-300">
                  La página territorial sigue enlazada al comportamiento vivo de la estación.
                </p>
              </div>

              <div className="overflow-hidden rounded-[1.7rem] border border-white/10 bg-white/5 sm:col-span-2">
                <img
                  src={sitePhotos.locationMap}
                  alt="Mapa de referencia del Muelle La Playa y su entorno cercano"
                  className="h-56 w-full object-cover"
                  loading="lazy"
                />
                <div className="p-5">
                  <p className="text-xs uppercase tracking-[0.24em] text-slate-500">Referencia visual del lugar</p>
                  <p className="mt-2 font-display text-2xl text-white">Muelle La Playa como punto reconocible del proyecto</p>
                  <p className="mt-3 text-sm leading-6 text-slate-300">
                    Esta vista ayuda a ubicar la estación dentro del borde costero y refuerza la relación entre telemetría y territorio.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
          <article className="panel p-8">
            ...
            <p className="mt-4 text-sm leading-7 text-slate-300">
              ...
              interfaz bonita: responde a un punto geográfico concreto y a un comportamiento ambiental real.
            </p>
          </article>
          ...
          <article className="panel-soft p-8">
            ...
            <div className="mt-6 grid gap-4 sm:grid-cols-2">
              ...
              <div className="rounded-[1.6rem] border border-white/10 bg-white/5 p-5">
                <p className="text-xs uppercase tracking-[0.24em] text-slate-500">Región</p>
                <p className="mt-3 font-display text-3xl text-white">{location.region}</p>
              </div>
              <div className="rounded-[1.6rem] border border-white/10 bg-white/5 p-5">
                <p className="text-xs uppercase tracking-[0.24em] text-slate-500">País</p>
